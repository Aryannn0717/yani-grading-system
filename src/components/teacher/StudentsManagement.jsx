...
import { Plus, Pencil, Trash, Upload, User, BookOpen, Mail, Key, Hash } from "lucide-react"
  ...
  return (
    <TeacherLayout title="Students">
      <div className="flex justify-between items-center mb-8">
        <div>
          <p className="text-gray-500 mt-1">Manage student profiles and academic records</p>
        </div>
        <button
          className="flex items-center gap-2 bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white px-4 py-2.5 rounded-lg transition-all shadow-md hover:shadow-lg focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
          onClick={() => {
        ...
        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          ...
          {credentials && (
            <div className="mt-3 p-3 bg-blue-50 rounded border border-blue-200 text-sm">
              <div className="font-medium text-blue-800 mb-1">Student Credentials:</div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="p-5 bg-gradient-to-r from-green-50 to-gray-50 border-b border-gray-200">
        ...
        <div className="p-5">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h4 className="text-lg font-medium text-gray-700 mb-1">No students enrolled</h4>
              <p className="text-gray-500">Begin by enrolling your first student</p>
            </div>
          ) : (
            <div className="overflow-x-auto rounded-lg border border-gray-200">
              <table className="w-full divide-y divide-gray-200">
                <thead className="bg-gradient-to-r from-green-50 to-gray-50">
                  <tr>
                    <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Student Profile</th>
                    <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID Number</th>
                    <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Contact</th>
                    <th className="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Enrolled Subjects</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {students.map((student) => (
                    <tr key={student.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-5 py-4 whitespace-nowrap text-sm text-gray-500">{student.student_id}</td>
                      <td className="px-5 py-4 whitespace-nowrap text-sm text-gray-500">{student.email}</td>
                      <td className="px-5 py-4 whitespace-nowrap text-sm text-gray-500">
                        <div className="flex flex-wrap gap-1">
                          {student.subjects?.length > 0 
                            ? student.subjects.map(id => 
                                subjects.find(s => s.id === id)?.code).join(", ")
                            : "Not enrolled"}
                        </div>
                      </td>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    Enroll in Subjects <span className="text-red-500">*</span>
                  </label>
