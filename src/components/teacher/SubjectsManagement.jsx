  ...
  return (
    <TeacherLayout title="Subjects">
      <div className="flex justify-between items-center mb-8">
        <div>
          <p className="text-gray-500 mt-1">Create and manage academic subjects</p>
        </div>
        <button
          className="flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-5 py-3 rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all shadow-lg hover:shadow-xl active:scale-[0.98]"
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden transition-all hover:shadow-md">
        <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-xl font-semibold text-gray-800">Subject Catalog</h3>
              <p className="text-gray-500 text-sm mt-1">{subjects.length} subjects registered</p>
            </div>
            <div className="relative">
              <input
                type="text"
                placeholder="Search subjects..."
                className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all w-64"
              />
              <svg
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h4 className="text-lg font-medium text-gray-700">No subjects found</h4>
              <p className="text-gray-500 mt-1 max-w-md mx-auto">Add your first subject to begin organizing your academic curriculum.</p>
              <button
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {subjects.map((subject) => (
                    <tr key={subject.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10 bg-emerald-100 rounded-full flex items-center justify-center mr-3">
                            <span className="text-emerald-800 font-medium">{subject.code.substring(0, 3)}</span>
                          </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-700">{subject.school_year}</div>
                      </td>
      ...
      {isAddDialogOpen && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden transform transition-all duration-300 scale-95 hover:scale-100">
            <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
              <h3 className="text-2xl font-bold text-gray-800">New Subject</h3>
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden transform transition-all duration-300 scale-95 hover:scale-100">
            ...
            <div className="p-6 space-y-5">
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="edit-semester" className="block text-sm font-medium text-gray-700 mb-2">
                      Semester
                    </label>
                    <select
                      id="edit-semester"
                  ...
                  <div>
                    <label htmlFor="edit-school_year" className="block text-sm font-medium text-gray-700 mb-2">
                      School Year
                    </label>
                    <input
                      id="edit-school_year"
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden transform transition-all duration-300 scale-95 hover:scale-100">
            <div className="p-6 border-b border-gray-200">
              ...
              <h3 className="text-2xl font-bold text-gray-800 text-center">Delete Subject?</h3>
              <p className="text-sm text-gray-500 mt-2 text-center">
                Are you sure you want to delete <span className="font-medium text-gray-700">{currentSubject?.name}</span>? This action cannot be undone.
              </p>
            </div>
